...
MODEL_CONFIGS = [
    ...
    },
    {
        "name": "qwen3b_ft",
        "hf_id": "Qwen/Qwen2.5-3B-Instruct",
        "adapter_dir": "outputs/qwen3b_epi_lora",
    },
    {
        "name": "phi35_base",
    ...
    },
    {
        "name": "phi35_ft",
        "hf_id": "microsoft/Phi-3.5-mini-instruct",
        "adapter_dir": "outputs/phi35_epi_lora",
    },
    {
        "name": "granite33_2b_base",
    ...
    },
    {
        ...
        "hf_id": "ibm-granite/granite-3.3-2b-instruct",
        "adapter_dir": "outputs/granite33_2b_epi_lora",
    },
]

ENSEMBLE_MEMBERS = ["qwen3b_ft", "phi35_ft", "granite33_2b_ft"]
...
def choose_ensemble_prediction(
    ...
    for model_name, pred in valid.items():
        ...
        score_tuple = (
            ...
            -len(pred["answer"]),
            1 if model_name == "qwen3b_ft" else 0,
        )
